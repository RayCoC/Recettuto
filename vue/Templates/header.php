...
<header>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <span class="navbar-text">  <li class="nav-item dropdown" style="list-style: none">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false"><img src="./img/user.png"
                                                                                class="userConnection"></a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="min-width: 0;">
                            ...
                            if (ControleurAuthentification::test_Connexion()) {
                                echo '<a class="dropdown-item" href="index.php?action=profil&login=' . $_SESSION['nomUtilisateur'] . '&module=mod_Profil" style="color: black;">Mon Compte</a></li>
    ...
    <ul class="nav justify-content-center">
        <li class="nav-item">
            <a class="nav-link active" class="link-dark" href="index.php?action=Accueil&module=mod_Accueil">Accueil
                |</a>
        </li>
        <li class="nav-item">
