                                                ...
                                                <td>
                                                    <ul class="list-inline m-0">
                                                        <li class="list-inline-item">
                                                            <a href="index.php?action=modifierIngredient&ingredient=<?=$value['nomIngredient']?>&module=mod_Recette"><i class="fa fa-edit"></i></a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a href="index.php?action=supprimerIngredient&ingredient=<?=$value['nomIngredient']?>&module=mod_Recette"><i class="fa fa-trash"></i></a>
                                                        </li>
                                                    </ul>
                                                </td>
                                                </tr>
