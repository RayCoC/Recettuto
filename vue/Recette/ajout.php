    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input name="titre" class="form-control" id="exampleFormControlInput1"
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" rows="3" name="desc"><?php if (isset($_POST['desc'])) {
                        echo $_POST['desc'];
                    } ?></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="button" value="Ajouter ingrédient !" onclick="cacher(document.getElementById('add'))"
                       class="submit"><br>
                <div id="add" class="hidden">
                    <input type="text" name="nomIngredient" class="info" placeholder="Ingredient"
                           value="<?php if (isset($_POST['nomIngredient'])) {
                               echo $_POST['nomIngredient'];
                           } ?>">
                    ...
                    <input type="text" name="unite" id="unite" class="info" placeholder="unite"
                           value="<?php if (isset($_POST['unite'])) {
                               echo $_POST['unite'];
                           } ?>">
                ...
                <label>Hashtag</label>
                <input type="button" value="ajouter Hashtag !" class="submit"
                       onclick="cacher(document.getElementById('hashtag'))"><br>
                <div id="hashtag" class="hidden">
                    <input type="text" name="hashtag" class="info" placeholder="Hashtag"
                           value="<?php if (isset($_POST['hashtag'])) {
                               echo $_POST['hashtag'];
                           } ?>">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="calories" class="hauteur" value="<?php if (isset($_POST['calories'])) {
                    echo $_POST['calories'];
                } ?>"><br><br>
