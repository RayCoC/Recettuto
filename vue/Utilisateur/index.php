    ...
    <script>
        $(document).ready(function () {
            $('#search').keyup(function() {
                ...
                if (user != "") {
                    $.ajax({
                        url : "http://localhost/index.php?action=search&user="+encodeURIComponent()+"&module=mod_Utilisateur",//"http://localhost/~rhamouche/Php_Projet/index.php?action=search&user="+encodeURIComponent()+"&module=mod_Utilisateur",
                        type : 'POST',
