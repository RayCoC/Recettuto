...
<div id= centerDiv>
    <article>
        <form action="index.php?action=inscriptionBD&module=mod_Authentification" method="post">
            ...
            <?php if(ModeleAuthentification::champVide($_POST["age"])){ echo "<p id='sexe' class='error'>Sexe n'est pas selectionner</p>";}?>

            <input type="number" id="number" name="age" placeholder="Age" value="<?php if(isset($_POST['age'])){ echo  $_POST['age'];}?>" class="input">
            <?php if(ModeleAuthentification::champVide($_POST["age"])){ echo "<p class='error'>Age n'est pas rempli</p>";}?>

            <input type="text" id="nom" name="nom" placeholder="Nom" value="<?php if(isset($_POST['nom'])){ echo  $_POST['nom'];}?>" class="input">
            <?php if(ModeleAuthentification::champVide($_POST["nom"])){ echo "<p class='error'>Nom n'est pas rempli</p>";}?>

            <input type="text" id="prenom" name="prenom" placeholder="Prenom" value="<?php if(isset($_POST['prenom'])){ echo  $_POST['prenom'];}?>" class="input">
            <?php if(ModeleAuthentification::champVide($_POST["prenom"])){ echo "<p class='error'>Prenom n'est pas rempli</p>";}?>
            ...
            <?php if(ModeleAuthentification::champVide($_POST["nomUtilisateur"])){ echo "<p class='error'>Nom d'utilisateur n'est pas rempli</p>";}?>

            <input type="password" id="mdp" name="mdp" placeholder="Mot de passe" class="input">
            <?php if(ModeleAuthentification::champVide($_POST["mdp"])){ echo "<p class='error'>Mot de passe n'est pas rempli</p>";}?>
