                        ...
                        <div class="col-xl-6">
                            <div class="card-body p-md-5 text-black">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <?php if (isset($_POST['valider'])) {
                                                if ($_POST["nom"] == "" && isset($_POST['valider'])) {
                                                    echo "<p class='error'>Nom n'est pas rempli</p>";
                                                }
                                            } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <?php if (isset($_POST['valider'])) {
                                                if ($_POST["prenom"] == "") {
                                                    echo "<p class='error'>Prenom n'est pas rempli</p>";
                                                }
                                            } ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <?php if (isset($_POST['valider'])) {
                                        if ($_POST["age"] == "") {
                                            echo "<p class='error'>Age n'est pas rempli</p>";
                                        }
                                    } ?>
                                </div>
                                <div class="form-outline mb-4">
                                    ...
                                    <?php if (isset($_POST['valider'])) {
                                        if ($_POST["nomUtilisateur"] == "") {
                                            echo "<p class='error'>Nom utilisateur pas rempli</p>";
                                        }
                                    } ?>
                                </div>
                                <div class="form-outline mb-4">
                                    ...
                                    <?php if (isset($_POST['valider'])) {
                                        if ($_POST["mdp"] == "") {
                                            echo "<p class='error'>Mot de passe n'est pas rempli</p>";
                                        }
                                    } ?>
                                </div>
                                <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
                                    ...
                                    <div class="form-check form-check-inline mb-0 me-4">
                                        ...
                                        <?php if (isset($_POST['valider'])) {
                                            if (!isset($_POST["sexe"])) {
                                                echo "<p id='sexe' class='error'>Sexe n'est pas selectionné</p>";
                                            }
                                        } ?>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end pt-3">
                                    ...
                                    <input type="submit" class="btn btn-lg ms-2" id="valider" value="Submit"
                                           name="valider">
                                </div>
                            </div>
                        </div>
...
<?php else: ?>
    <div class="alert alert-danger alert-dismissible fade show mt-5">
        ...
        <p>Il semble que vous soyez déjà connecté sur le site. Vous devez d'abord vouis deconnecter pour creer un
            compte.</p>
        <hr>
